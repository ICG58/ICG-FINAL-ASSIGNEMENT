...
# the price of the products. Apart from that, other major role in financial return is that the system also helps with calculations of selling price, cost price and it output the # # inancial return percentage.
